...
const products = async (req,res)=>{
    ...
    result.prevLink = result.hasPrevPage ? `https://proyectofinalcoderhouse-production-1caa.up.railway.app/products?page=${result.prevPage}&limit=${limit}&sort=${sort}&category=${category}` : '';
    result.nextLink = result.hasNextPage ? `https://proyectofinalcoderhouse-production-1caa.up.railway.app/products?page=${result.nextPage}&limit=${limit}&sort=${sort}&category=${category}` : '';
...
const users = async (req,res)=>{
    ...
    result.prevLink = result.hasPrevPage ? `https://proyectofinalcoderhouse-production-1caa.up.railway.app/users?page=${result.prevPage}&limit=${limit}&category=${role}` : '';
    result.nextLink = result.hasNextPage ? `https://proyectofinalcoderhouse-production-1caa.up.railway.app/users?page=${result.nextPage}&limit=${limit}&category=${role}` : '';
    result.isValid= !(page<=0||page>result.totalPages)
